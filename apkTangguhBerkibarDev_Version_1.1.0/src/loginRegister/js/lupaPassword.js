...
// TODO: LINK RESET ADA SEDIKIT MISS DIMANA JIKA TERDAPAT LINK LAMA YANG SUDAH MELEBIHI BATAS WAKTU DAN JINKA LINK BARU DIKIRIM MAKA LINK LAMA BISA MENGAKSES FORMNYA SEHARUSNYA TIDAK DIPERBOLEHKAN HAL INI BERKAITAN DENGAN RESET PASSWORD 
...
async function handleEmailLink() {
  ...
  try {
    ...
    if (user) {
      ...
      // timestamp reset password ke node pengguna berdasarkan UID
...
function initializePage() {
  ...
  // Memanggil functuion email input
